export default {
  ...
  'newSession.browser.title': 'Browse directories',
  'newSession.browser.description': 'Browse the selected machine and choose a working directory.',
  'newSession.browser.up': 'Up',
  'newSession.browser.refresh': 'Refresh',
  'newSession.browser.selectCurrent': 'Use this directory',
  'newSession.browser.loading': 'Loading directory…',
  'newSession.browser.empty': 'This directory is empty.',
  'newSession.browser.enter': 'Open',
  'newSession.browser.loadError': 'Failed to load directory',
  'newSession.browser.type.file': 'File',
  'newSession.browser.type.directory': 'Folder',
  'newSession.browser.type.other': 'Other',
