export default {
  ...
  'newSession.browser.title': '浏览目录',
  'newSession.browser.description': '浏览所选机器上的目录，并选择工作目录。',
  'newSession.browser.up': '上一级',
  'newSession.browser.refresh': '刷新',
  'newSession.browser.selectCurrent': '使用当前目录',
  'newSession.browser.loading': '目录加载中…',
  'newSession.browser.empty': '该目录为空。',
  'newSession.browser.enter': '打开',
  'newSession.browser.loadError': '加载目录失败',
  'newSession.browser.type.file': '文件',
  'newSession.browser.type.directory': '文件夹',
  'newSession.browser.type.other': '其他',
